# Jira Ticket Fetcher Agent with Ollama

An AI-powered Python agent that uses local Ollama LLM to intelligently fetch, analyze, and answer questions about Jira tickets using the Jira REST API.

## Features

- ✅ **LLM-Powered Analysis**: Uses Ollama for intelligent ticket analysis
- ✅ **Natural Language Interface**: Ask questions in plain English
- ✅ **Fetch Individual Tickets**: Get detailed ticket information
- ✅ **Search with JQL**: Query tickets using Jira Query Language
- ✅ **Interactive Chat Mode**: Conversational interface for Jira operations
- ✅ **Secure Credentials**: Uses .env files for configuration
